...
;; STATE.scm - Project state tracking for idris2-xml-7-44-toolkit
;; Media-Type: application/vnd.state+scm

(define-state idris2-xml-7-44-toolkit
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "idris2-xml-7-44-toolkit")
    (repo "hyperpolymath/idris2-xml-7-44-toolkit"))

  (project-context
    (name "idris2-xml-7-44-toolkit")
