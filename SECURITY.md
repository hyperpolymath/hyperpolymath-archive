...
Replace all {{PLACEHOLDER}} values with your information:
  hyperpolymath-archive     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  hyperpolymath-archive             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/hyperpolymath-archive/security/advisories/new)
...
- This repository (`hyperpolymath/hyperpolymath-archive`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/hyperpolymath-archive/security/advisories)
...
When using hyperpolymath-archive, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/hyperpolymath-archive/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/hyperpolymath-archive/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/hyperpolymath-archive/discussions) |
...
*Thank you for helping keep hyperpolymath-archive and its users safe.* 🛡️
